...
let favoriteBook = Book(title: "BookTitle", author: "BookAuthor", pages: 300, price: 9.99)
...
let laptop1 = Laptop(yearPurchased: 2026)

let laptop2 = Laptop(screenSize: 13, repairCount: 1, yearPurchased: 2026)
/*:
