...
if nameInCaps.lowercased() == name.lowercased() {
    print("\(nameInCaps.lowercased()) + \(name.lowercased()) are the same")
} else {
    print("\(nameInCaps.lowercased()) + \(name.lowercased()) are not the same")
}
...
if nameInCaps == name
{print("\(nameInCaps) + \(name) are the same.")}
else {print("\(nameInCaps) + \(name) are not the same")}
