...
if let validArea = calculateArea(x: 5.0, y: 4.0) {
    print(validArea)
} else {
    print("bloop")
}

if let invalidArea = calculateArea(x: -3.0, y: 4.0) {
    print(invalidArea)
} else {
    print("bloop")
}
...
if let result = add(4, 6) {
    print("Sum:", result)
} else {
    print("bloop")
}

if let result = add(nil, 6) {
    print("Sum:", result)
} else {
    print("bloop")
}
...
firstNameTextField.text = "Brandon"
lastNameTextField.text = "Carbee"
