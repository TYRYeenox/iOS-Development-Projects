...
struct User {
    ...
    static var currentUser = User(userName: "Brandon", email: "brandon.carbee@gmail.com", age: 35)
 ...
 */
let newUser = User(userName: "Brandonn", email: "brandon.carbee2@gmail.com", age: 35)
