...
if let meal1 = getMeal("Breakfast") {
    print(meal1)
} else {
    print("No meal logged")
}

if let meal2 = getMeal("Dinner") {
    print(meal2)
} else {
    print("No meal logged")
}

// I was getting errors when not using an if-let statement here.
/*:
