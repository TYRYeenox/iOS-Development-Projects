...
struct ProfileView: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 15) {
            ...
            Text("Real Name: Brandon")
                .font(.custom("MarkerFelt-Wide", size: 15))
                .foregroundStyle(.black)
            
            Text("Home City: VA Beach, Virginia")
                .font(.custom("MarkerFelt-Wide", size: 20))
                .foregroundStyle(.green)
            
            Text("Bio: Gamer, future developer. ")
                .font(.custom("MarkerFelt-Wide", size: 20))
...
struct BlogPostView: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 15) {
            ...
            Text("Posted on 26 Feb 26")
                .font(.custom("MarkerFelt-Wide", size: 15))
                .foregroundStyle(.gray)
            
            Text("""
This is my example of a  blog post!
""")
            .font(.custom("MarkerFelt-Wide", size: 20))
            .foregroundStyle(.brown)
            
            Text("❤️ 25 Likes   💬 25 Comments")
                .font(.custom("MarkerFelt-Wide", size: 15))
                .foregroundStyle(.pink)
        }
        .padding()
